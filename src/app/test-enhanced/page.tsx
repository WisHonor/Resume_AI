...
import sampleData from "@/test-data/enhanced-sample.json";
...
function TestSection({ title, score, tips, examples, icon }: {
    ...
    return (
        <FlippableCard 
            variant="gradient" 
            className="group h-full flex flex-col min-h-[500px]"
            examples={examples || []}
        ...
        >
            ...
            <div className="flex-1 overflow-y-auto max-h-[350px] pr-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
            ...
            <div className="relative z-10 p-6 md:p-10 max-w-[1400px] mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg">
                        Testing bigger cards with more tips and examples
                    </p>
                </div>
